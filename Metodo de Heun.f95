PROGRAM Metodo_de_Heun								!SOLO MODIFICAR FUNCION HASTA EL FINAL!
...
WRITE(*,*)'Bienvenido al programa para Resolver EDO por el Metodo de Heun'
...
DOUBLE PRECISION :: h
DOUBLE PRECISION :: ynew
DOUBLE PRECISION :: dy1dx
DOUBLE PRECISION :: dy2dx
...
!Evaluar Expresion
F=y*(x**2)-y				!!!!!!!!!!!!!!!!!!!!!!!!!!!!ESTO ES LO QUE SE DEBE CAMBIAR!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
